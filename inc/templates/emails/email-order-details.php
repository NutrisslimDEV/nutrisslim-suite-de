...
// Calculate shipping cost with tax and round
$shipping_with_tax = $order->get_shipping_total() + $order->get_shipping_tax();
$rounded_shipping_with_tax = wc_price(round($shipping_with_tax, wc_get_price_decimals()));

// Display total (already rounded by WooCommerce)
$rounded_total = wc_price(round($order->get_total(), wc_get_price_decimals()));


// Initialize subtotal including tax
$subtotal_with_tax = 0;



// Loop through order items and ensure each price is rounded
foreach ($order->get_items() as $item_id => $item) {
    $product = $item->get_product();
    $item_quantity = $item->get_quantity();
    
    // Calculate item price including tax, rounded
    $item_price = round(wc_get_price_including_tax($product), wc_get_price_decimals());
    $item_total = round($item_price * $item_quantity, wc_get_price_decimals());
...
foreach ($order->get_items() as $item_id => $item) {
    ...
    // Calculate price including tax with rounding as per your logic
    $item_price_incl_tax = round(($item->get_total() + $item->get_total_tax()) / $item_quantity, wc_get_price_decimals());
    $item_total_incl_tax = round($item_price_incl_tax * $item_quantity, wc_get_price_decimals());

    // Format prices
    $item_price_formatted = wc_price($item_price_incl_tax);
    $item_total_formatted_single = wc_price($item_total_incl_tax);

    // Add numeric total to the overall total
    $product_total += $item_total_incl_tax;
}

// Format the final product total for display
$product_total_full = wc_price($product_total);
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Bestellnummer:', 'woocommerce');?></span>
                    ...
                    ?>
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Datum:', 'woocommerce');?></span>
                    ...
                    <![endif]-->
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Gesamt', 'woocommerce');?>:</span>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 15px; text-align: center; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Produkt', 'woocommerce'); ?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 15px; text-align: center; font-size: 12px; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Anzahl', 'woocommerce'); ?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Preis', 'woocommerce');?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
...
<div style="background-color:transparent;">
    <div class="block-grid three-up no-stack"
        ...
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
            ...
            <div class="col num4" style="max-width: 320px; min-width: 206px; display: table-cell; vertical-align: top;">
                <div style="width:100% !important;">
                    <div style="padding-top:15px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                        <div style="color:#555555;line-height:120%;padding-left:22px; text-align: left;">
                            <div style="font-size: 12px; line-height: 14px; color: #555555;">
                                <p style="font-size: 14px; line-height: 19px; margin: 0;">
                                    <span style="font-size: 14px;"><?php echo esc_html($item_name); ?><br></span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col num4" style="max-width: 320px; min-width: 206px; display: table-cell; vertical-align: top;">
                <div style="width:100% !important;">
                    <div style="padding-top:10px; padding-bottom:10px;">
                        <table border="0" cellpadding="0" cellspacing="0" class="divider" role="presentation"
                            style="table-layout: fixed; vertical-align: top; min-width: 100%;" valign="top"
                            width="100%">
                            <tbody>
                                <tr valign="top">
                                    <td valign="top"
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            class="divider_content" valign="top" width="100%">
                                            <tbody>
                                                <tr valign="top">
                                                    <td valign="top" style="text-align: center;">
                                                        <p
                                                            style="font-size: 12px; line-height: 19px; text-align: center; margin: 0;">
            ...
            <div class="col num4" style="max-width: 320px; min-width: 206px; display: table-cell; vertical-align: top;">
                <div style="width:100% !important;">
                    <div style="padding-top:15px; padding-bottom:0px;">
                        <div
                            style="color:#555555;line-height:120%;padding-right:10px;padding-bottom:20px;padding-left:10px;">
                            <div style="font-size: 12px; line-height: 14px; color: #555555;">
                                <p style="font-size: 12px; line-height: 19px; text-align: center; margin: 0;">
                                    <span style="font-size: 14px;">
                                        <strong><?php echo $item_total_formatted_single; ?></strong>
                                    </span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;"><span
                                        style="font-size: 14px;"><?php echo __('Produkte', 'woocommerce'); ?><br><span
                                            style="font-size: 12px; line-height: 14px; white-space: nowrap;"><?php echo __('(inkl. MwSt.)', 'woocommerce'); ?></span></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 12px; line-height: 19px; text-align: center; margin: 0;"><span
                                        style="font-size: 14px;"><strong><?php
                                            echo $product_total_full;
                                            ?></strong></span>
                                </p>
                            </div>
                        </div>
                    ...
                    <![endif]-->
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;">
                                    <span
                                        style="font-size: 14px;"><?php echo __('Versandbetrag', 'woocommerce'); ?><br><span
                                            style="font-size: 12px; line-height: 14px; white-space: nowrap;"><?php echo __('(inkl. MwSt.)', 'woocommerce'); ?></span></span>
                                </p>
                            </div>
                        </div>
...
foreach ( $order->get_fees() as $fee ) {
    ...
    $fee_total_incl_tax = wc_price( $fee_total + $fee_total_incl_tax );
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;">
                                    <?php echo __('Zahlungsmethode:', 'woocommerce'); ?></p>
                                <p style="font-size: 14px; line-height: 19px; margin: 0;"><span
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0; text-align:left">
                                    ...
                                    <strong><?php echo __('BIC / Mauersegler', 'woocommerce'); ?>:

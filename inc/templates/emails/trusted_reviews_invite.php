        ...
        <div
            ...
            <p style="line-height: 19px; font-size: 12px; text-align: center; margin: 0; margin-bottom:10px;"
                align="left"><span style="line-height: inherit; font-size: 14px;"><strong
                        style="line-height: inherit;"><?php echo __('Bewerten Sie Nature’s Finest und erhalten Sie eine Belohnung!', 'nutrisslim-suite'); ?></strong></span>
            </p>
            <p
                ...
                <?php echo __('Wir streben stets danach, unsere Produkte und Dienstleistungen zu verbessern und schätzen Ihr Feedback sehr', 'nutrisslim-suite'); ?>
            </p>
            <p
                style="margin: 0; margin-bottom:10px; font-size: 14px; line-height: 21px; color: #555555; font-family: 'Oxygen', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                <?php echo __('<b>Bewerten Sie Ihre Erfahrung mit uns</b> - und als Dankeschön senden wir ein <b>spezielles Geschenk</b> zu Ihrer Bestellung', 'nutrisslim-suite'); ?>
            </p>
            ...
            <p
                ...
                <a href="<?php echo $trusted_review_link; ?>" target="_blank"
                    ...
                    bgcolor="#1fb25a">
                    <?php echo __('BEWERTEN SIE DEN SHOP JETZT', 'nutrisslim-suite'); ?>
                </a>
            </p>
            <p
                ...
                <a href="<?php echo $trusted_review_link; ?>" target="_blank"
                    style="text-decoration:none!important; color: #555555!important;"><?php echo __('Sieh dir den Rest an', 'nutrisslim-suite'); ?>
                    <img align="center" alt="Image" border="0" class="center autowidth "
                        ...
                        title="Image" width="82" height="14"> <?php echo __(' Bewertungen!', 'nutrisslim-suite'); ?></a>
            </p>
        </div>
    </div>
</div>
...
class Nutrisslim_Landing_Quantity_Selector extends Widget_Base {
    ...
    protected function render() {
        ...
        if ($singlePriceWithTax >= $free_shipping_threshold) {
            $shippingCost = __('Kostenlose Lieferung', 'nutrisslim-suite');
        } else {
            $shippingCost = floatval(str_replace(',', '.', $shippingCost));
            $shippingCost = __('Versandkosten', 'nutrisslim-suite') . ' ' . wc_price($shippingCost);
        }
                ...
                <div class="slick-track" style="opacity: 1; width: 450px;">
                    <div class="slide slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
                        ...
                        <div class="slider-flex">
                            <span class="slide-content"><?php _e('BESTELLFORMULAR', 'nutrisslim-suite'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 pt-3 icon-check icon-primary-color text-center">
                ...
                <div class="col-12 pt-3 shipping-details">
                    <?php
                            ...
                            echo sprintf( __('%s innerhalb von 3-4 Werktagen', 'nutrisslim-suite'), $delivery_type, $courier, $from, $to ) . '</p>';
                            ?>
                </div>

                <?php if (!empty($quantities[1]['price']) || !empty($quantities[2]['price'])) { ?>
                <div class="text-center cta-notice">
                    <h3><?php _e('Mehr kaufen, mehr sparen', 'nutrisslim-suite'); ?></h3>
                </div>
                <?php } else {
                            ...
                            echo '<p class="redno">' . __('Normaler Preis', 'woocommerce') . ':<br /><span><s>' . wc_price($regular_price) . '</s></span></p>';
...
<div id="upsell-block" class="style-a<?php echo $upsell_block_option == 'upsell-block-a' ? '' : ' d-none'; ?>"
    ...
    <?php
                    $custom_titles = array(
                        1 => !empty($package_1_text) ? $package_1_text : __('Bestelle 1 Paket', 'nutrisslim-suite'),
                        2 => !empty($package_2_text) ? $package_2_text : __('Bestelle 2 Pakete', 'nutrisslim-suite'),
                        3 => !empty($package_3_text) ? $package_3_text : __('Bestelle 3 Pakete', 'nutrisslim-suite')
                    );

                    $custom_titles2 = array(
                        1 => __('1x Paket', 'nutrisslim-suite'),
                        2 => __('2x Pakete', 'nutrisslim-suite'),
                        3 => __('3x Pakete', 'nutrisslim-suite')
                    );
                    ...
                    foreach ($quantities as $key => $item) {
                        ...
                        if ($key == 1) {
                            echo '<div class="text-center cta-notice mobile"><h3>' . __('Kaufe mehr, spare mehr', 'nutrisslim-suite') . '</h3></div>';
                        }
        ...
        <div class="offer-container">
            ...
            <div class="bottom">
                                ...
                                <label for="checked0<?php echo $num; ?>">
                                    ...
                                    <?php 
                                                            if ($consumption_period && $duration > 0) {
                                                                echo '<p style="font-size: smaller; padding-left: 20px; font-weight:300; padding-top: 10px"> für  ' . $duration . ' Tage</p>';
                                                            }
                                                            ?>
                                </label>
                            </div>
                            <div class="price">
                                <div class="price-old price-small">
                                    <span class="line-through precrtano">
                                        <?php echo sprintf(__('Regulärer Preis %s', 'nutrisslim-suite'), wc_price($regular_price * $num)); ?>
                                    </span>
                                </div>
                ...
                <div class="offer_shipping">
                    ...
                    <?php _e('Kostenlose Lieferung', 'nutrisslim-suite'); ?>
                </div>
                <?php } ?>
                ...
                <div class="offer_shipping">
                    ...
                    <?php _e('Kostenloses Geschenk', 'nutrisslim-suite'); ?>
                </div>
                <?php } ?>
            </div>
        </div>
        ...
        <label for="offer<?php echo $key; ?>" class="offer-label">
            <div class="offer-container">
                ...
                <div class="offer_shipping">
                    ...
                    <?php _e('Darmowa dostawa', 'nutrisslim-suite'); ?>
                </div>
                <?php } ?>
...
<?php endif; ?>
        ...
        <?php if ($upsell_block_option == 'upsell-block-c') : ?>
            ...
            <div id="upsell-block" class="style-c<?php echo $upsell_block_option == 'upsell-block-c' ? '' : ' d-none'; ?>"
                ...
                $custom_titles = array(
                    1 => !empty($package_1_text_c) ? $package_1_text_c : __('1+1 FREI', 'nutrisslim-suite'),
                    2 => !empty($package_2_text_c) ? $package_2_text_c : __('2+2 FREI ', 'nutrisslim-suite'),
                    3 => !empty($package_3_text_c) ? $package_3_text_c : __('3+3 FREI ', 'nutrisslim-suite'),
                );
                ...
                $custom_subtitles = array(
                    ...
                    2 => !empty($package_2_subtitle_c) ? $package_2_subtitle_c : __('+ zusätzliche 5% sparen', 'nutrisslim-suite'),
                    3 => !empty($package_3_subtitle_c) ? $package_3_subtitle_c : __('+ zusätzliche 10% sparen', 'nutrisslim-suite'),
                );

                // Upsell block C - custom main text

                $custom_titles2 = array(
                    1 => !empty($package_1_maintext_c) ? $package_1_maintext_c : __('2 Produkte erhalten', 'nutrisslim-suite'),
                    2 => !empty($package_2_maintext_c) ? $package_2_maintext_c : __('4 Produkte erhalten', 'nutrisslim-suite'),
                    3 => !empty($package_3_maintext_c) ? $package_3_maintext_c : __('6 Produkte erhalten', 'nutrisslim-suite'),
                );
                ...
                foreach ($quantities as $key => $item) {
                    ...
                    if ($key == 1) {
                        echo '<div class="text-center cta-notice mobile"><h3>' . __('Mehr kaufen, mehr sparen', 'nutrisslim-suite') . '</h3></div>';
                    }
                            ...
                            <div class="offer-container">
                                ...
                                <div class="bottom">
                                    ...
                                    <span class="price-per-product-text">
                                        ...
                                        <?php _e('/ pro Produkt', 'nutrisslim-suite'); ?>
                                    </span>
                                            </div>
                                        ...
                                        <div class="offer-left">
                                            ...
                                            type="checkbox" ' . ($key == 0 ? 'checked' : '') .
                                                    ...
                                                    <label for="checked0_c_<?php echo esc_attr($num); ?>">
                                                        ...
                                                        if ($consumption_period && !empty($duration)) {
                                                            echo '<p style="font-size: smaller; padding-left: 20px; font-weight:300; padding-top: 5px; font-family: "Fira Sans", Sans-serif"> für ' . esc_html($duration) . ' Tage</p>';
                                                        }
                                                        ?>
                                                    </label>
                                                </div>
                                            ...
                                            <span class="line-through precrtano regularofferc">
                                                <?php
                                                echo sprintf(
                                                    __('Normaler Preis: %s', 'nutrisslim-suite'),
                                            ...
                                            <span class="offerc-price eec totalofferc">
                                                <?php
                                                echo __('Insgesamt: ', 'nutrisslim-suite'); // Add "Total:" before the price

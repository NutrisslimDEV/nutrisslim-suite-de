                ...
                <div class="revContent">
                    ...
                    <div class="rateMeta">
                        ...
                        <div class="checker"><span class="check"><img
                            ...
                            <?php echo __('Verifizierter Benutzer', 'nutrisslim-suite'); ?></div>
                    </div>
    ...
    <div class="col contHolder product-short-description">
        ...
        <?php
                ...
                if ( !empty($consumption_period) ) {
                    $consumptionPeriodOutput = sprintf( __('für %s Tage', 'nutrisslim-suite'), $consumption_period );
                }
                ...
                echo '<p class="redno">' . __('Regulärer Preis', 'woocommerce') . ':<br /><span>' . wc_price($regular_price) . '</span></p>';
                echo '<div class="price-main price-large">' . wc_price($price_for_one) . '</div>';
                echo '<p><a href="#order-form-anchor" class="org-btn">' . __('Jetzt bestellen', 'woocommerce') . '</a></p>';
                echo '<p class="prihrani">' . __('und spare', 'nutrisslim-suite') . ' ' . wc_price($regular_price - $price_for_one) . '</p>';
                echo '<p>' . __('100 % sicherer Kauf mit einer Rückgaberecht ohne Fragen.', 'nutrisslim-suite') . '</p>';
            ?>
    </div>
</div>
<?php

...
function product_rating_shortcode($atts) {
    ...
    if ($review_data['review_count'] > 0) {
        ...
        if ($review_data['review_count'] == 1) {
            $output .= '<div class="checker"><span class="check checkbelo"><img src="/wp-content/uploads/2025/05/checkGreen.svg"></span> ' . $review_data['review_count'] . ' ' . __('Verifizierte Bewertungen', 'nutrisslim-suite') . '</div>';
        } elseif ($review_data['review_count'] == 2) {
            $output .= '<div class="checker"><span class="check checkbelo"><img src="/wp-content/uploads/2025/05/checkGreen.svg"></span> ' . $review_data['review_count'] . ' ' . __('Verifizierte Bewertungen', 'nutrisslim-suite') . '</div>';
        } else {
            $output .= '<div class="checker"><span class="check checkbelo"><img src="/wp-content/uploads/2025/05/checkGreen.svg"></span> ' . $review_data['review_count'] . ' ' . _n('Verifizierte Bewertungen', 'Verifizierte Bewertungen', $review_data['review_count'], 'nutrisslim-suite') . '</div>';
        }
        // $output .= '</div>';

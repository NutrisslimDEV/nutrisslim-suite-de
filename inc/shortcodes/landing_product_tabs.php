...
<?php
    ...
    if ($warnings) {
        $uporaba .= '<p style="margin-top:.9rem;"><strong>' . __( 'Warnung:', 'nutrisslim-suite' ) . '</strong></p>';
        $uporaba .= $warnings;
    } 
    ...
    if ($uporaba) {
        $tabLists .= '<li class="uporaba_tab active" id="tab-title-uporaba" role="tab" aria-controls="tab-uporaba"><a href="#tab-uporaba">' . __( 'Verwendung', 'nutrisslim-suite' ) . '</a></li>';
    ...
    if ($sastavnine) {
        $tabLists .= '<li class="sestavine_tab" id="tab-title-sestavine" role="tab" aria-controls="tab-sestavine"><a href="#tab-sestavine">' . __( 'Zutaten', 'nutrisslim-suite' ) . '</a></li>';
    ...
    if ($hranilne) {
        $tabLists .= '<li class="hranilne_vrednosti_tab" id="tab-title-hranilne_vrednosti" role="tab" aria-controls="tab-hranilne_vrednosti"><a href="#tab-hranilne_vrednosti">' . __( 'Nährwerte', 'nutrisslim-suite' ) . '</a></li>';
